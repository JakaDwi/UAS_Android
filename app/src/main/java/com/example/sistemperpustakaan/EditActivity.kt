package com.example.sistemperpustakaan

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.view.View
import android.widget.Toast
import com.example.sistemperpustakaan.db.NoteDao
import com.example.sistemperpustakaan.db.NoteRoomDatabase
import com.example.sistemperpustakaan.model.Note
...
class EditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_save.setOnClickListener {
            ...
            if (title.isEmpty() && body.isEmpty()){
                Toast.makeText(applicationContext, "Gagal! Tidak Boleh Kosong", Toast.LENGTH_SHORT).show()
            }
            else{
                if (isUpdate){
    ...
    private fun saveNote(note: Note){
        ...
        Toast.makeText(applicationContext, "Judul Tersimpan", Toast.LENGTH_SHORT).show()

    }

    private fun deleteNote(note: Note){
        dao.delete(note)
        Toast.makeText(applicationContext, "Judul Berhasil Dihapus", Toast.LENGTH_SHORT).show()
    }
}
